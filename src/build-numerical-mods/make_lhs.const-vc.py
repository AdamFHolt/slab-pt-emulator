...
df.to_csv(DATA_DIR / "params-list.const-vc.csv", index=False, float_format="%.6e")
np.save(DATA_DIR / "params-list.const-vc.npy", X)
print(f"[OK] Saved {df.shape} → {DATA_DIR}/params-list.const-vc.[csv|npy]")
