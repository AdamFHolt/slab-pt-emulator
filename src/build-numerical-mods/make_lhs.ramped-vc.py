...
unit = lhs(len(RANGES), samples=N_SAMPLES, criterion='maximin', random_state=SEED) # N×6 array of [0,1] values
...
df.to_csv(DATA_DIR / "params-list.ramped-vc.csv", index=False, float_format="%.6e")
np.save(DATA_DIR / "params-list.ramped-vc.npy", X)
print(f"[OK] Saved {df.shape} → {DATA_DIR}/params-list.ramped-vc.[csv|npy]")
