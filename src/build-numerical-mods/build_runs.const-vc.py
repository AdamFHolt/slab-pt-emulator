...
LHS_FILE      = ROOT / "data" / "params" / "params-list.const-vc.npy"
TEMPLATE_FILE = ROOT / "data" / "ref-model" / "model_template_fixed-trench.const-vc.prm"
OUT_DIR       = ROOT / "subd-model-runs" / "const-vc" / "run-inputs" 
...
COLS = [
    "v_conv","age_SP","age_OP","dip_int","eta_UM",
]
...
for idx, row in enumerate(rows):
    ...
    with open(rundir / f"run_{idx:03d}.prm", "w") as f:
        f.write("# This file is auto-generated by build_runs.const-vc.py\n")
        f.write("# Params:\n")
